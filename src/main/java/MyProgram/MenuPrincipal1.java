 ...
 */
public class MenuPrincipal1 extends javax.swing.JDialog {

    /**
     * Creates new form MenuPrincipal
     */
    public MenuPrincipal1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnEventos.setBackground(new java.awt.Color(255, 153, 51));
        btnEventos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MyProgram/Image/Edit.png"))); // NOI18N
    ...
    private void btnEventosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEventosMouseClicked
        String[] Opciones = {"Crear Evento", "Eliminar evento", "Recompensas"};
        int op = JOptionPane.showOptionDialog(this, "Que deseas realizar", "Gestion de Eventos", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, Opciones, Opciones[0]);
        switch(op){
            case 0:
                //Crear Evento
                String titulo=JOptionPane.showInputDialog(this, "Inserta el titulo del evento", "Titulo", JOptionPane.PLAIN_MESSAGE);
                String descripcion=JOptionPane.showInputDialog(this, "Inserta la descripcion del evento", "Descripcion", JOptionPane.PLAIN_MESSAGE);
                int valor= Integer.parseInt(JOptionPane.showInputDialog(this, "Inserta el valor $ del evento", "Valor", JOptionPane.PLAIN_MESSAGE));
                JOptionPane.showMessageDialog(this, registrarEvento(titulo, descripcion, valor));
                break;
            case 1:
                // Eliminar Evento
                String eliminar = JOptionPane.showInputDialog(this, "Inserta el titulo del evento", "Titulo", JOptionPane.PLAIN_MESSAGE);
                JOptionPane.showMessageDialog(this, eliminarEvento(eliminar));
                break;
            case 2:
                //Recompensa
                String usuariorecompensa = JOptionPane.showInputDialog(this, "Inserta el Usuario al que vas a recompensar $", "Recompensa", JOptionPane.PLAIN_MESSAGE);
                int valorrecompensa = Integer.parseInt(JOptionPane.showInputDialog(this, "Inserta el valor $ que gano el Usuario ", "Valor", JOptionPane.PLAIN_MESSAGE));
                Recompensa(usuariorecompensa,valorrecompensa);
                break;
            default:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuPrincipal1 dialog = new MenuPrincipal1(new javax.swing.JFrame(), true);
